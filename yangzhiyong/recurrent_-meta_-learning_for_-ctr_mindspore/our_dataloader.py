...
class our_Data_loader():
    ...
    def __next__(self):
        ...
        users = ms.Tensor(np.array(users))
        users_hists_targets = ms.Tensor(np.array(users_hists_targets))
        users_hists_targets_y = ms.Tensor(np.array(users_hists_targets_y))
        new_hist_info = ms.Tensor(np.array(new_hist_info))
        users_hists_len = ms.Tensor(np.array(users_hists_len))
        new_hist_y = ms.Tensor(np.array(new_hist_y))
