...
conf_parser.add_argument('--dataset', type=str,default="ml-1m",required = False)
conf_parser.add_argument('--start', type=int,default=1,required = False)
conf_parser.add_argument('--end', type=int,default=2,required = False)
conf_parser.add_argument('--ablation_type', type=int,default=0,required = False)

conf_parser.add_argument('--learning_rate', default=0.01, type=float)
...
conf_parser.add_argument('--regularizer_weight_decay',default=0.01,type=float)
...
conf_parser.add_argument('--loss_weight_alpha', type=float,default=0.7,required = False)
...
conf_parser.add_argument('--OTHER_EMBEDDING_SIZE', type=int,default=16,required = False)
